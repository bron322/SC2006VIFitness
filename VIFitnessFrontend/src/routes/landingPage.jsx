    ...
    <>
      <div className="landing-page-wrapper">
        ...
        <div className="-translate-y-1/2 -translate-x-1/2 flex flex-col items-center justify-center top-2/3 left-1/2 z-10 absolute">
          <h2 className="cssanimation sequence fadeInBottom font-sans font-bold justify-self-center">Welcome to</h2>
          <h2 className="cssanimation sequence fadeInBottom font-sans font-bold pb-20">VIFitness</h2>
          <a href="#macros" id="browse" className="cssanimation sequence fadeInBottom flex flex-col items-center bg-black rounded-3xl p-3 shadow-md">
